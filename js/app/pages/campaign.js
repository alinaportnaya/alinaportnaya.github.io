            ...
            <div class="wrapper">
                <div class="flex">
                    ...
                    <div class="w20 al ptb20">
                        <a class="btnS" href="#" @click.prevent="parent.formData=data.info; $refs.new.active=1"><i class="fas fa-edit"></i><span> Edit campaign</span></a>
                    </div>
                </div>
            </div>
       ...
       <div class="wrapper">
            <div class="flex">
                ...
                <div class="w20 al ptb20 mtb">
                    <a class="btnS" href="#" @click.prevent="parent.formData={}; $refs.ad.active=1"><i class="fas fa-plus"></i> <span>New<span></a>
                </div>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="(item, i) in data.items">
                            ...
                            <td class="ac"><a href="#" @click.prevent="parent.formData = item; $refs.ad.active=1;">{{item.size}}</a></td>
