            ...
            <div class="wrapper">
                <div class="flex">
                    ...
                    <div class="w20 al ptb20 pb0">
                        <a class="btnS" href="#" @click.prevent="parent.formData=user; $refs.new.active=1"><i class="fas fa-edit"></i> <span>Edit user</span></a>
                    </div>
                </div>
            ...
            <div v-if="tab == 2">
                <div class="flex payments">
                    ...
                    <div class="w20 al ptb15">
                        <a class="btnS" href="#" @click.prevent="parent.formData={}; $refs.payment.active=1"><i class="fas fa-plus"></i><span> Add payment</span></a>
                    </div>
                </div>
                ...
                <popup ref="payment" :title="(parent.formData && parent.formData.id) ? 'Edit payment' : 'New payment'">
                    <div class="form inner-form">
                        <form @submit.prevent="actionPayment()" v-if="parent.formData">
                            ...
                            <div class="row">
                                <label>Date</label>
                                <input type="date" v-model="parent.formData.date" class="p-date" required>
                            </div>
                            <div class="row">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr v-for="item in data.statistics">
                                ...
                                <td class="image ac">{{item.size}}</td>
                                <td>{{item.link}}</td>
                                <td class="id">
                                    {{item.views}}
                                </td>
