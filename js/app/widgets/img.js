export var img = {
    ...
    template:`
        <div class="image-preview-area ac">
        ...
        <input type="file" class="pt15" data-name="image" ref="input" accept="image/jpeg, image/png, image/gif, image/webp, image/svg+xml" @change="change($event)">
`
};